...
(function (root, factory) {
  ...
  var document = window.document,
    ...
    renderDay = function (opts, date, dummy, extraClass) {
      ...
      if (
        ...
        extraClass = extraClass.filter(function (el) {
          return (
            ['lightpick__day', 'is-available', 'is-previous-month', 'is-next-month'].indexOf(el) >=
            0
          );
        });
      ...
      if (opts.disableDates) {
        for (var i = 0; i < opts.disableDates.length; i++) {
          if (
            ...
            Object.prototype.toString.call(opts.disableDates[i]) === '[object Array]'
          ) {
          ...
          if (day.className.indexOf('is-disabled') >= 0) {
            if (
              ...
              (!opts.startDate || date.isAfter(opts.startDate) || (opts.startDate && opts.endDate))
            ) {
    ...
    checkDisabledDatesInRange = function (el, opts) {
      if (opts.disabledDatesInRange || !opts.startDate || opts.endDate || !opts.disableDates)
        return;
        ...
        if ((opts.startDate && !opts.endDate) || opts.repick) {
          ...
          [].forEach.call(days, function (day) {
            ...
            if (
              ...
              if (
                ((opts.startDate && !opts.endDate) || opts.repickTrigger === opts.secondField) &&
  ...
  Lightpick.prototype = {
    ...
    updatePosition: function () {
      ...
      if (
        ...
        (!orientation[1] || orientation[1] == 'auto' || !/left|right/.test(orientation[1]))
      ) {
    ...
    setStartDate: function (date, preventOnSelect) {
      ...
      if (this._opts.singleDate || this._opts.secondField) {
        ...
        this._opts.field.value =
          this._opts.startDate.format(this._opts.format) + this._opts.separator + '...';
      }
